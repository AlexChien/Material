...
CREATE  TABLE IF NOT EXISTS `catalogs_materials` (
  ...
  `price` DECIMAL(8,2) NOT NULL DEFAULT 0 COMMENT 'internal purchase price' ,
  `created_at` DATETIME NULL ,
  `updated_at` DATETIME NULL ,
...
CREATE  TABLE IF NOT EXISTS `orders` (
  ...
  `region_id` INT NOT NULL ,
  `amount` DECIMAL(8,2) NOT NULL DEFAULT 0 COMMENT 'total amount of budget required' ,
...
CREATE  TABLE IF NOT EXISTS `transfer_line_items` (
  ...
  `material_id` INT NOT NULL ,
  `quantity` INT NOT NULL DEFAULT 0 ,
  `unit_price` DECIMAL(8,2) NOT NULL DEFAULT 10 ,
  `subtotal` DECIMAL(8,2) NOT NULL DEFAULT 0 ,
  `created_at` DATETIME NULL ,
  `updated_at` DATETIME NULL ,
  PRIMARY KEY (`id`) ,
...
INSERT INTO regions (`id`, `name`, `assigned_budget`, `used_budget`, `redeemable_budget`, `is_central`, `phone`, `city`, `address`, `zip`, `created_at`, `updated_at`) VALUES ('2', '华北区', '0', '0', '0', '0', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO regions (`id`, `name`, `assigned_budget`, `used_budget`, `redeemable_budget`, `is_central`, `phone`, `city`, `address`, `zip`, `created_at`, `updated_at`) VALUES ('3', '华东区', '0', '0', '0', '0', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO regions (`id`, `name`, `assigned_budget`, `used_budget`, `redeemable_budget`, `is_central`, `phone`, `city`, `address`, `zip`, `created_at`, `updated_at`) VALUES ('4', '华南区', '0', '0', '0', '0', NULL, NULL, NULL, NULL, NULL, NULL);
